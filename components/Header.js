...
const NavButton = ({isWhite, style, navigation}) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.openDrawer()}>
    <Icon
      family="font-awesome"
      size={24}
      name="navicon"
      color={theme.COLORS[isWhite ? 'WHITE' : 'ICON']}
      style={isWhite ? styles.whiteIcon : styles.headerIcon}
    />
  </TouchableOpacity>
);
  ...
  renderRight = () => {
    ...
    if (title ===  'Title') {
      return ([
        ...
        <NavButton key='nav-button' navigation={navigation} isWhite={white} />
      ]);
    }
    ...
    return (
      <Block style={headerStyles}>
        <NavBar
          ...
          leftIconName={back ? 'ios-rewind' : null}
          leftIconFamily="ionicon"
          leftIconColor={white ? theme.COLORS.WHITE : theme.COLORS.ICON}
          titleStyle={[
            styles.title,
            white ? styles.whiteHeader : { color: theme.COLORS.ICON },
          ]}
